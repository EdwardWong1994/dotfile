...
vim.cmd([[
   nnoremap <slient> <expr> <leader>dl ":GdbStartLLDB lldb " . input("debug file path: ") . "\<ESC>"
     nnoremap <slient> <expr> <leder>dp ":GdbStartPDB python -m" . input("debug file path: ") . "\<ESC>"
    nnoremap <slient> <expr> <leder>db ":GdbStartBashDB bashdb" . input("debug file path: ") . "\<ESC>"
]])
